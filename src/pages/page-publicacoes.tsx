        ...
        <section className="mt-8 w-full items-end flex gap-x-6">
          <div className="w-[700px] flex flex-col items-start gap-y-4">
            <p className="w-full text-[14px] text-black/40 font-medium">
              ...
              numquam ab. Ipsa nesciunt excepturi quas earum praesentium
              doloribus repellat cumque expedita itaque ducimus quisquam magni
              magnam possimus, tempore ullam eos id consectetur doloremque nam
              error accusantium, ut iusto dicta reprehenderit. Obcaecati, sequi
              ullam blanditiis illo esse quos perspiciatis corrupti!
            </p>
